...
$(function(){
    ...
    window.vesti.photoCarousel = ({
        ...
        _fakeImgManipulation: function() {
            ...
            var FAKE_IMG_TMPL = '<div class="photo-carousel__item_fake"><img src="data:image/png;base64," alt=""></div>',
        ...
        changeImg: function($currentImgLink) {
            ...
            this.$mainImg.attr('src', $currentImgLink.attr('data-big-img'));
            ...
            if (   $('.photo-carousel').length  ) {    //когда много фото
                ...
                $('.photo-carousel').find('a').each(function(i) {
                    ...
                    _this.imgArray[i] =  {
                        ...
                        bigImg:  (_this.ifPhotoGalleryPage) ? $(this).attr('data-big-img').replace('xw_', 'o_') : $(this).attr('data-big-img'),
                    ...
                    tmplMainBlock += '<div class="media__main-item" ><img src="' + _this.imgArray[i].bigImg + '" alt="">';
                ...
                this.imgArray[0] = {};
                this.imgArray[0].bigImg =  $('.article__img img').attr('src');
    ...
    window.vesti.themeCarousel = ({
        ...
        showVideo: function($el) {
            var vid = $el.attr('data-video-id'),
                videoSrc = 'http://player.rutv.ru/iframe/video/id/' + vid +  '/start_zoom/true/showZoomBtn/false/sid/vesti/isPlay/true/';
...
$(function(){
    ...
    window.vesti.showVideo = ({
        ...
        insertVideoVh: function() {
            this.overlay.$el.find('.overlay__content')
                .html(' <iframe class="overlay__video" frameborder="0" style="width: 100%; height: 100%;" src="' + this.videoUrl + '"></iframe>')
        },
    ...
    window.vesti.broadcasts = ({
        ...
        changeBlocks: function() {
            ...
            if (this.$link.hasClass('title__broadcasts-link_archive')) {
                ...
                linkText = "Архив трансляций";
                titleText = "Трансляции";
...
$(document).ready(function(){
    ...
    function second_passed() {
        fixedTop = Math.ceil($('#fixed-adv-block').parents('.main-content').position().top + $('#fixed-adv-block').prev().position().top + $('#fixed-adv-block').prev().height() + 24);
        if($('.promo').length){
            fixedTop = fixedTop +  $('.promo').height();
        }
    }
    ...
    frame.onresize = function(){
        ...
        maxScroll = Math.ceil($('.footer').position().top-$('#fixed-adv-block').height()-34);
...
$(function() {
    ...
    window.vesti.itemsLayout = ({
        ...
        buildLayout: function() {
            ...
            var _this = this;
            if ($('.news-wrapper').length) this.makeLayout($('.news-wrapper .b-item'), $('.news-wrapper'), 1280);
